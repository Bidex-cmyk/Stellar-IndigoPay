...
* **frontend:** route donation XLM/USD value display through the backend on-chain oracle endpoint instead of a hardcoded CoinGecko feed, and drop CoinGecko from the CSP `connect-src` (closes #687)
